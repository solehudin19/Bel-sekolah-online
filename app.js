...
function renderEdit(){
  ...
  tbody.innerHTML='';
  if(!entries.length){
    tbody.innerHTML=`<tr><td colspan="4" style="text-align:center;color:var(--text2);padding:1.5rem;font-size:13px">Belum ada jadwal. Klik "+ Tambah bel"</td></tr>`;
    return;
  }
  entries.forEach((e,i)=>{
    const tr=document.createElement('tr');
    ...
    tr.append(tdJam,tdKeg,tdTrack,tdChk);
    tbody.appendChild(tr);
  });
}
